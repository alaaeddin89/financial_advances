        ...
        <div class="col-md-12   ">
            <div class="card" style="text-align: right;">
                ...
                <div class="card-body py-1">
                    ...
                    <form id="form1" class="form" method="POST" action="{{route("branches.update",$branch->id)}}">
                    @method("put")
                    @csrf
                    <!--begin::Input group-->
                        <div class="row g-9 mb-8">
                            ...
                            <div class="col-md-4 fv-row">
                                ...
                                <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                    <span class="required">اسم الفرع</span>
                                    <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip"
                                       title=" title "></i>
                                </label>
                                <!--end::Label-->
                                <input type="text" name="name_ar" class="form-control " value="{{old("name",$branch->name_ar)}}">
