        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
               ...
               <div class="d-flex justify-content-end" data-table-toolbar="base">
                    ...
                    <a href="{{route("messages.create")}}" class="btn btn-success "> مراسلة جديدة <i class="fa fa-plus"></i></a>
            ...
            <!--begin::Table-->
                <table id="table_id"
                    ...
                    <tr class="fw-bolder  bg-secondary text-muted ">
                        ...
                        <th class="min-w-20px text-center" ># رقم</th>
                        <th class="min-w-150px text-center" >المرسل</th>
                        <th class="min-w-150px text-center" >الرسالة</th>
                        <th class="min-w-125px text-center">تاريخ المراسلة</th>
...
@push('js')
    ...
    @include('messages._datatable')
    {{--@include("parts.sweetDelete", ['route' => route('categories.destroy', ['category' => ':id'])]) --}}
@endpush
